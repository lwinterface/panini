...
def run_anthill():
    app = ant_app.App(
        ...
        logfiles_path=testing_logs_directory_path,
        log_in_separate_process=True,
    )
...
def test_simple_log():
    ...
    time.sleep(0.1)
    with open(os.path.join(testing_logs_directory_path, 'test_logs_in_separate_process.log'), 'r') as f:
