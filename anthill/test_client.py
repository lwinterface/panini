...
class TestClient:
    ...
    def start(self, is_sync=False):
        ...
        self.anthill_process = start_process(self.anthill_app.start, daemon=is_daemon)
    ...
    def wait(self, count: int = None) -> None:
        self.nats_client.wait(count=count)

    def terminate(self):
        self.anthill_app.close()
